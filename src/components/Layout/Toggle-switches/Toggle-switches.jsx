...
const StyledWrapper = styled.div`
  .toggle-cont {
    ...
    z-index: 10;
    width: fit-content;
    height: 28px; /* زودنا الإرتفاع */
    transform: scale(0.7); /* زودنا السكيل علشان يبقى أكبر */
  ...
  .toggle-label {
    --gap: 3px; /* زودنا الجاب */
    --width: 28px; /* زودنا العرض */
    cursor: pointer;
    position: relative;
    display: inline-block;
    padding: 0.35rem; /* زودنا البادنج */
  ...
  .toggle-label::before {
    ...
    width: calc(100% + 2rem); /* زودنا الحجم */
    height: calc(100% + 2rem); /* زودنا الحجم */
  ...
  .cont-icon {
    ...
    border-bottom: 0;
    border-radius: 9999px;
    box-shadow: inset 0 -0.2rem 0.2rem var(--primary), /* زودنا الظل */
      inset 0 0 0.6rem 0.9rem var(--second);
  ...
  .icon {
    width: 0.65rem; /* زودنا حجم الأيقونة */
    fill: var(--light);
  }
  ...
  .toggle-input:checked + .toggle-label::before {
    box-shadow: 0 1.2rem 3rem -2.5rem #0080ff; /* زودنا الظل */
  }
