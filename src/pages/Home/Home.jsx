...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Video Section */}
      <section className="relative -mt-[200px] z-10 bg-[var(--agenko-background-dark)]">
      ...
      {/* Services Section */}
      <section className="relative py-32 bg-[var(--agenko-background-dark)] transition-colors duration-300">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-end mb-12">
            <div className="w-full lg:w-6/12 mb-8 lg:mb-0">
              <div className="mb-8">
                <span className="inline-block border border-[var(--agenko-primary-green)] text-[var(--agenko-heading-light)] px-4 py-2 rounded-full mb-3">Our Service</span>
                <h2 className="text-4xl lg:text-5xl font-bold text-[var(--agenko-heading-light)] leading-tight" data-aos="fade-up" data-aos-offset="250">
            ...
            <div className="w-full lg:w-6/12 text-left lg:text-right">
              <p className="text-[var(--agenko-text-muted)] max-w-md ml-auto" data-aos="fade-up">
                We are a <span className="text-[var(--agenko-primary-green)]">digital Creative agency</span> with 25 years of experience, specializing in delivering cutting-edge solutions.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-6/12 lg:w-4/12 px-4 mb-8" data-aos="fade-up" data-aos-delay="0" data-aos-offset="250">
              <div className="p-8 bg-[var(--agenko-surface-dark)] border border-[var(--agenko-border-dark)] transition-all duration-300 ease-out">
                <div className="mb-4 text-[var(--agenko-primary-green)] text-4xl">
                  <i className="fas fa-laptop-code"></i>
                </div>
                <h4 className="text-xl font-bold text-[var(--agenko-heading-light)] mb-3">Website Development</h4>
                ...
                <a href="service-details.html" className="hover:text-[var(--agenko-primary-green)] text-[var(--agenko-heading-light)] transition-all duration-300 ease-out hover:underline font-medium">Learn More</a>
              </div>
            </div>

            <div className="w-full md:w-6/12 lg:w-4/12 px-4 mb-8" data-aos="fade-up" data-aos-delay="400" data-aos-offset="250">
              <div className="p-8 bg-[var(--agenko-surface-dark)] border border-[var(--agenko-border-dark)] transition-all mt-14 md:mt-12">
                <div className="mb-4 text-[var(--agenko-primary-green)] text-4xl">
                  <i className="fas fa-bullhorn"></i>
                </div>
                <h4 className="text-xl font-bold text-[var(--agenko-heading-light)] mb-3">Digital Marketing</h4>
                <p className="text-[var(--agenko-text-muted)] mb-4">
            ...
            <div className="w-full md:w-6/12 lg:w-4/12 px-4 mb-8" data-aos="fade-up" data-aos-delay="400" data-aos-offset="250">
              <div className="p-8 bg-[var(--agenko-surface-dark)] border border-[var(--agenko-border-dark)] transition-all duration-300 ease-out mt-24 md:mt-14 lg:mt-26">
                <div className="mb-4 text-[var(--agenko-primary-green)] text-4xl">
                  <i className="fas fa-palette"></i>
                </div>
                <h4 className="text-xl font-bold text-[var(--agenko-heading-light)] mb-3">Creative Branding</h4>
                <p className="text-[var(--agenko-text-muted)] mb-4">
                  We design distinctive branding and visual identities that connect with your audience, boosting brand recognition.
                </p>
                <a href="service-details.html" className="hover:text-[var(--agenko-primary-green)] text-[var(--agenko-heading-light)] transition-all duration-300 hover:underline font-medium">Learn More</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 bg-[var(--agenko-background-dark)] transition-colors duration-300">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full lg:w-7/12 px-4" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0">
              <div className="mb-16 group bg-[var(--agenko-surface-dark)] border border-[var(--agenko-border-dark)] p-4 rounded-2xl" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0">
                <div className="relative overflow-hidden rounded-2xl mb-5">
                  ...
                  <div className="absolute bottom-6 left-6 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <a href="#" className="px-4 py-2 bg-[var(--agenko-surface-dark)] text-[var(--agenko-heading-light)] rounded-full text-sm hover:bg-[var(--agenko-primary-green)] hover:text-[var(--agenko-background-dark)] transition-colors">
                      Website
                    </a>
                    <a href="#" className="px-4 py-2 bg-[var(--agenko-surface-dark)] text-[var(--agenko-heading-light)] rounded-full text-sm hover:bg-[var(--agenko-primary-green)] hover:text-[var(--agenko-background-dark)] transition-colors">
                      Landing Page
                ...
                <div>
                  <h4 className="text-2xl font-bold text-[var(--agenko-heading-light)] mb-3 hover:text-[var(--agenko-primary-green)] transition-colors">
      ...
      <section className="relative py-20 bg-[var(--agenko-background-dark)] transition-colors duration-300">
        <div className="container mx-auto px-4">
          ...
          <div className="relative z-10">
            <div className="hidden lg:block absolute top-6 z-[-1] left-0 right-0 w-full h-px bg-[var(--agenko-border-dark)]"></div>
            <div className="flex flex-wrap">
              <div className="w-full md:w-6/12 lg:w-3/12 px-4 mb-8 text-center">
                ...
                <div className="p-6 bg-[var(--agenko-surface-dark)] border border-[var(--agenko-border-dark)] rounded-xl" data-aos="fade-up"  data-aos-delay="0" data-aos-offset="20">
                  ...
                  <h5 className="text-lg font-bold text-[var(--agenko-heading-light)] mb-2">Research</h5>
                  <p className="text-[var(--agenko-text-muted)]">In-depth research to uncover insights and drive informed decisions.</p>
                </div>
              </div>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 px-4 mb-8 text-center">
                ...
                <div className="p-6 bg-[var(--agenko-surface-dark)] border border-[var(--agenko-border-dark)] rounded-xl" data-aos="fade-up"  data-aos-delay="0" data-aos-offset="30">
                  ...
                  <h5 className="text-lg font-bold text-[var(--agenko-heading-light)] mb-2">Concept Design</h5>
                  <p className="text-[var(--agenko-text-muted)]">Creative concept designs that transform ideas into impactful solutions.</p>
                </div>
              </div>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 px-4 mb-8 text-center">
                ...
                <div className="p-6 bg-[var(--agenko-surface-dark)] border border-[var(--agenko-border-dark)] rounded-xl" data-aos="fade-up"  data-aos-delay="0" data-aos-offset="40" >
                  ...
                  <h5 className="text-lg font-bold text-[var(--agenko-heading-light)] mb-2">Implementation</h5>
                  <p className="text-[var(--agenko-text-muted)]">Efficient implementation of tailored strategies to achieve your goals.</p>
                </div>
              </div>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 px-4 mb-8 text-center">
                ...
                <div className="p-6 bg-[var(--agenko-surface-dark)] border border-[var(--agenko-border-dark)] rounded-xl" data-aos="fade-up"   data-aos-delay="0" data-aos-offset="50">
                  ...
                  <h5 className="text-lg font-bold text-[var(--agenko-heading-light)] mb-2">Testing</h5>
                  <p className="text-[var(--agenko-text-muted)]">Rigorous testing to ensure flawless functionality and optimal user experience.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full lg:w-6/12 px-4 mb-12 lg:mb-0">
              <div className="text-center lg:text-left">
                <span className="inline-block border border-[var(--agenko-primary-green)] text-[var(--agenko-heading-light)] px-4 py-2 rounded-full mb-3">
                  Company
                </span>
                <h2 className="text-4xl lg:text-5xl font-bold text-[var(--agenko-heading-light)] leading-tight">
                  Trusted Our Company
                </h2>
                <p className="text-[var(--agenko-text-muted)] text-lg">
                  We are a{" "}
                  <span className="text-[var(--agenko-primary-green)]">
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="grid grid-cols-3 gap-0 bg-[var(--agenko-surface-dark)]">
                <div className="client-item border border-[var(--agenko-border-dark)] p-8 text-center hover:border-[var(--agenko-primary-green)] transition-colors bg-[var(--agenko-surface-dark)]">
                  <img
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center mb-12">
            <div className="w-full lg:w-7/12 mb-8 lg:mb-0">
              <div className="mb-6">
                <span className="inline-block text-sm font-semibold border border-[var(--agenko-primary-green)] text-[var(--agenko-heading-light)] px-4 py-2 rounded-full uppercase tracking-wider mb-3">Our Team</span>
                <h2 className="text-4xl lg:text-5xl font-bold text-[var(--agenko-heading-light)] leading-tight">
                  Meet Our Talented
                  <br />
                  Skillful Team
          ...
          <div className="flex flex-wrap">
            {teamImages.map((img, idx) => (
              <div key={idx} className="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                <div className="overflow-hidden bg-[var(--agenko-surface-dark)]">
                  <div className="relative">
                    <img src={img} alt={`Team member ${idx + 1}`} className="w-full" />
                    <div className="absolute top-3 right-3 bg-[var(--agenko-heading-light)] rounded-full p-2">
                      <a href="team-details.html" className="text-[var(--agenko-background-dark)] w-5 h-5 flex items-center justify-center rounded">
                        <i className="far fa-plus"></i>
                      </a>
                    </div>
                  </div>
                  <div className="p-4">
                    <span className="block text-sm text-[var(--agenko-text-muted)] mb-2">
                      {positions[idx]}
                    </span>
                    <h5 className="text-lg font-bold text-[var(--agenko-heading-light)]">{names[idx]}</h5>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-12">
            <div className="lg:w-1/2 mb-8 lg:mb-0">
              <span className="inline-block text-sm font-semibold border border-[var(--agenko-primary-green)] text-[var(--agenko-heading-light)] px-4 py-2 rounded-full uppercase tracking-wider mb-3">
                Our Award
              </span>
              <h2 className="text-4xl lg:text-5xl font-bold text-[var(--agenko-heading-light)] leading-tight">
            ...
            <div className="lg:w-1/2 lg:pl-12">
              <p className="text-[var(--agenko-text-muted)] text-lg lg:text-right">
                We are a <span className="text-[var(--agenko-heading-light)] font-semibold">digital Creative agency</span> with 25 years of experience, specializing in delivering cutting-edge
              </p>
            </div>
          </div>
              ...
              <div className="space-y-5">
                <div className="flex flex-wrap justify-between items-center dark:bg-[var(--agenko-surface-dark)] hover:bg-[var(--agenko-surface-darker)] bg-amber-50 p-6 lg:px-10 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="0" >
                  ...
                  <div className="w-full md:w-[50%] mb-4 md:mb-0 text-center md:text-left">
                    <h5 className="text-lg text-[var(--agenko-heading-light)] group-hover:text-[var(--agenko-primary-green)] transition-colors duration-300 font-semibold">
      ...
      {/* Testimonial Section */}
      <section className="relative py-32 bg-[var(--agenko-background-dark)] overflow-hidden">
        <div className="absolute -bottom-5/12 -left-1/5 w-32 h-32 rounded-full bg-[var(--agenko-primary-green)] opacity-10 blur-3xl">
          <span className="w-96 h-96"></span>
        </div>
        <div className="absolute bottom-20 right-10 w-40 h-40 rounded-full bg-[var(--agenko-primary-green)] opacity-10 blur-3xl"></div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 relative">
              <div className="absolute top-0 left-0 text-[80px] lg:text-[100px] font-bold text-[var(--agenko-heading-light)] opacity-5 pointer-events-none select-none leading-none">
                TESTIMONIAL
              </div>
              ...
              <div className="relative z-10">
                      ...
                      <div className="px-4">
                        <div className="flex gap-2 mb-10">
                          {[...Array(testimonial.rating)].map((_, i) => (
                            <svg 
                              key={i} 
                              className="w-6 h-6 fill-[var(--agenko-primary-green)]" 
                              viewBox="0 0 20 20"
                            >
                        ...
                        <p className="text-xl lg:text-3xl font-bold text-[var(--agenko-heading-light)] italic leading-relaxed mb-8">
                          "{testimonial.text}"
                        </p>

                        <div>
                          <h4 className="text-xl font-bold text-[var(--agenko-heading-light)] mb-1">
                            {testimonial.name}
                          </h4>
                          <h5 className="text-lg text-[var(--agenko-text-muted)]">
                ...
                <div className="flex gap-4 mt-12">
                  <button
                    ...
                    className="w-12 h-12 rounded-full bg-[var(--agenko-surface-dark)] hover:bg-[var(--agenko-primary-green)] border border-[var(--agenko-border-dark)] flex items-center justify-center text-[var(--agenko-heading-light)] transition-all duration-300 group"
